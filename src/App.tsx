          ...
          <div className="relative h-full w-full bg-white z-50 flex flex-col animate-in slide-in-from-left duration-300">
            ...
            <main {...verticalDragProps} className="flex-1 p-[4%] overflow-y-auto no-scrollbar text-slate-800 cursor-grab active:cursor-grabbing">
               {currentView === 'awards' ? (
                 ...
                 <div className="flex flex-col items-center justify-center py-20 opacity-30"><div className="text-6xl mb-[clamp(12px,3vw,16px)]">{currentView === 'shop' ? '🎁' : '👤'}</div><p className="font-black text-[clamp(14px,3.5vw,16px)] uppercase">界面设计中...</p></div>
               )}
            </main>
          </div>
        )}
